...
public final class CameraUtils {
    ...
    public static void chooseFrameRate(Camera.Parameters parameters) {
        ...
        if (DEBUG) {
            ...
            buffer.append(']');
            Log.e(TAG, "chooseFrameRate: Supported FPS ranges " + buffer.toString());
        }
    ...
    public static int[] choosePreviewSize(Camera.Parameters parameters, int width, int height) {
        ...
        if (DEBUG) {
            ...
            sb.append("]");
            Log.e(TAG, "choosePreviewSize: Supported preview size " + sb.toString());
        }
    ...
    public static void setExposureCompensation(Camera camera, float value) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.e(TAG, "setExposureCompensation: " + compensation);
            }
        ...
        try {
            ...
            if (parameters.getMaxNumFocusAreas() > 0 &&
                ...
                if (parameters.getMaxNumMeteringAreas() > 0) {
                    ...
                    if (DEBUG) {
                        Log.e(TAG, "handleFocusMetering: setMeteringAreas 1 " + focusRect);
                    }
                }
...
//                    return; //cannot autoFocus
                ...
                parameters.setMeteringAreas(meteringAreas);
                if (DEBUG) {
                    Log.e(TAG, "handleFocusMetering: setMeteringAreas 2 " + focusRect);
                }
                camera.cancelAutoFocus();
                setParameters(camera, parameters);
                camera.autoFocus(new Camera.AutoFocusCallback() {
        ...
        ThreadHelper.getInstance().runOnUiPostDelayed(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (DEBUG) {
                        Log.e(TAG, "resetFocus focusMode:" + focusMode);
                    }
