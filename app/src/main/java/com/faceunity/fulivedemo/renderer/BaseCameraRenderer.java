...
public class BaseCameraRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        Log.e(TAG, "onSurfaceChanged. viewWidth:" + width + ", viewHeight:" + height
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        int fbo_texture= draw_manager.GetTextureID();                       //获取纹理ID
    ...
    public void hideImageTexture() {
        Log.e(TAG, "hideImageTexture() called");
        mShotBitmap = null;
        mIsStopPreview = false;
        mGlSurfaceView.queueEvent(new Runnable() {
            @Override
    ...
    public void showImageTexture(final Bitmap bitmap) {
        ...
        Log.e(TAG, "showImageTexture() called with: bitmap = [" + bitmap + "]");
        mIsStopPreview = true;
        mShotBitmap = bitmap;
