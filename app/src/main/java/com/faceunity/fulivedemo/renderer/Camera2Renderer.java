...
public class Camera2Renderer extends BaseCameraRenderer implements ImageReader.OnImageAvailableListener {
        ...
        try {
            ...
            mCameraManager.openCamera(cameraId, new CameraDevice.StateCallback() {
                ...
                public void onOpened(@NonNull CameraDevice camera) {
                    Log.e(TAG, "onCameraOpened: " + camera + ", thread:" + Thread.currentThread().getName());
                ...
                public void onDisconnected(@NonNull CameraDevice camera) {
                    Log.e(TAG, "onCameraDisconnected: " + camera);
                    camera.close();
                    mCameraDevice = null;
                }
    ...
    protected void closeCamera() {
        Log.e(TAG, "closeCamera. thread:" + Thread.currentThread().getName());
    ...
    protected void startPreview() {
        ...
        try {
            ...
            Log.e(TAG, "startPreview. rangeFPS: " + rangeFps);
            ...
            mCameraDevice.createCaptureSession(surfaceList, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                    Log.e(TAG, "onConfigured: " + session + ", thread:" + Thread.currentThread().getName());
                    mIsPreviewing = true;
