...
public class VideoRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        try {
            ...
            Log.e(TAG, "onSurfaceChanged: location:" + location + ", genre:" + genre);
        } catch (Exception e) {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        Log.e(TAG, "onSurfaceChanged() viewWidth:" + width + ", viewHeight:" + height + ", videoWidth:"
    ...
    private void createExoMediaPlayer() {
        Log.e(TAG, "createExoMediaPlayer: ");
    ...
    private void releaseExoMediaPlayer() {
        Log.e(TAG, "releaseExoMediaPlayer: ");
...
//                    break;
                case Player.STATE_READY:
                    if (playWhenReady) {
                        Log.e(TAG, "onPlayerStateChanged: prepared " + Thread.currentThread().getName());
                        mGlSurfaceView.requestRender();
                    }
                    break;
                case Player.STATE_ENDED:
                    Log.e(TAG, "onPlayerStateChanged: completion " + Thread.currentThread().getName());
